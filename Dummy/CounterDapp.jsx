...
// Dummy version of Counter DApp component
// - No wallet provider required
// - No blockchain reads/writes
// - Uses local state to simulate connection, count, and tx status
const CounterDappDummy = () => {
  ...
  const handleConnect = () => {
    setIsConnected(true);
    setAddress('0x742d...C2F3');
  };

  const handleIncDec = (isInc) => {
    if (!isConnected) return;
    setResult(null);
    // Simulate async transaction delay
    setTimeout(() => {
      setCount((prev) => (isInc ? prev + 1 : Math.max(0, prev - 1)));
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Counter DApp (Dummy)</h1>
          <p className="text-gray-600 text-lg">UI-only demo using local state</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="text-center mb-8">
              <div className="bg-gray-50 rounded-2xl p-8 mb-6">
                <h2 className="text-lg font-medium text-gray-600 mb-4">Current Count</h2>
            ...
            <div className="space-y-4">
              ...
              {!isConnected && (
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  ...
                  <p className="text-sm text-blue-600 mt-1">Connect your wallet to interact with the counter</p>
                </div>
              )}
            </div>
          </div>
...
export default CounterDappDummy;
